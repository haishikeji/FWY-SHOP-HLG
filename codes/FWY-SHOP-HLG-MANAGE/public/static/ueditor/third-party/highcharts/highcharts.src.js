...
(function() {
  ...
  defaultOptions = {
    ...
    global: {
      useUTC: true,
      canvasToolsURL:
        "http://code.highcharts.com/3.0.6/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/3.0.6/gfx/vml-radial-gradient.png",
    },
    chart: {
      //animation: true,
      //alignTicks: false,
            ...
            if (span !== " ") {
              ...
              if (!spanNo && lineNo) {
                ...
                attr(
                  ...
                  // : revisit this with future versions of Safari
  ...
  Pointer.prototype = {
    ...
    pinchTranslateDirection: function(
      ...
      if (!inverted) {
        // : implement clipping for inverted charts
  ...
  // : When IE11 is released, check again for this bug, and remove the fix
  ...
  Series.prototype = {
    ...
    setData: function(data, redraw) {
      var series = this,
        ...
        xAxis = series.xAxis,
        names =
          xAxis && xAxis.categories && !xAxis.categories.length ? [] : null,
        i;
    ...
    getExtremes: function() {
      ...
      for (i = 0; i < yDataLength; i++) {
        ...
        validValue =
          y !== null && y !== UNDEFINED && (!yAxis.isLog || y.length || y > 0);
        withinRange =
    ...
    translate: function(positions) {
      ...
      var series = this,
        ...
        endAngleRad = (series.endAngleRad =
          (mathPI / 180) * ((options.endAngle || startAngle + 360) - 90)), // docs
