<template>
  <div class="page">
    <el-card style="margin-bottom: 10px">
      <div class="header">
        <div class="header__title">秒杀商品</div>
      </div>
    </el-card>
    <el-card class="container">
      ...
      >
        <div class="inline-form">
          ...
          <el-form-item label="限购数量" class="inline-form_item">
            <el-input
              v-model="limitedQuantity"
              type="number"
              placeholder="不限"
              :disabled="disabled"
            ></el-input>
    ...
    >
      ...
      >
        ...
        <el-form-item label="秒杀价" prop="sellPrice">
          <el-input
            :disabled="specificationDisabled"
  ...
  data() {
    return {
      ...
      specificationsFormRules: {
        ...
        barCode:[{ required: true, message: '请填写条形码', trigger: 'change' }],
  ...
  methods: {
    getDetail() {
      serve.getDetails(this.commodityId).then((res) => {
        ...
        this.limitedQuantity = res.data.limitedQuantity
        this.timeArea = [
    ...
    addSpecificationsDialogClick() {
      if(!this.specificationsFormData.sellPrice || this.specificationsFormData.sellPrice == 0) {
    ...
    submitForm() {
      this.$refs['form'].validate((valid) => {
        ...
        delete data.voList;
        console.log(data.specificationDtoList[0],123);
          ...
          if (this.mode == 0) {
            ...
            serve.add(data).then((res) => {
              if (res.code == 200) {
                ...
                this.$router.push('/home/goods/seckillGood');
              } else {
